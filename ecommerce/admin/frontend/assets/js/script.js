...
$(document).ready(function() {
    const config = window.ecommerceAdminConfig || {};
    const authKey = 'ecommerce_admin_auth';
    const emailKey = 'ecommerce_admin_email';
    const passwordKey = 'ecommerce_admin_password';
    const resetKeyStorage = 'ecommerce_admin_reset_key';
    const defaultEmail = (config.adminEmailDefault || 'bughunter@ecommerce.com').toLowerCase();
    const defaultPassword = config.adminPasswordDefault || 'BugHunter@2026';
    const defaultResetKey = config.resetKey || 'ECOMMERCE-RESET-2026';
...
function buildDefaultSiteSettings() {
    return {
        brand: {
            name: 'E-commerce',
            logo: 'frontend/assets/images/logo/ecommerce-logo.webp',
            favicon: 'frontend/assets/images/favicon/ecommerce-watches-icon.ico'
        },
        contact: {
        ...
        socialLinks: [
            { id: 1, label: 'Facebook', url: 'https://www.facebook.com/ecommerce', icon: 'bi bi-facebook' },
            { id: 2, label: 'X', url: 'https://x.com/ecommerce', icon: 'bi bi-twitter' },
            { id: 3, label: 'Instagram', url: 'https://www.instagram.com/ecommerce', icon: 'bi bi-instagram' }
        ],
        sliderImages: [
            {
                id: 1,
